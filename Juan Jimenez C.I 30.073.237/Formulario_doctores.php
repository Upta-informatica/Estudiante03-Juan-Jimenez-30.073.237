...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <form class="formulario" id="formulario" name="formulario" method="POST" action="insertar_doctores.php">
      <div class="contenedor-inputs">
        <h4 class="text-xl-center">Crear nuevo doctor</h4>
